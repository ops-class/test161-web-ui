  ...
  render: function() {
    return (
      <div>
          ...
          <div className="sectionbody">
            <div className="paragraph lead">
              <p><code>test161</code> is the OS/161 testing tool designed and implemented by
                <a href="https://blue.cse.buffalo.edu/people/shaseley/">Scott Haseley</a> and
                <a href="https://blue.cse.buffalo.edu/people/ychen78/">Yihong Chen</a>. It will both allow
            ...
            <div className="paragraph">
              <p>Below we run through how to install, configure, run, and use <code>test161</code>. While
                ...
                <a href="https://github.com/ops-class/test161/blob/master/README.adoc">README</a> located
                on the project’s <a href="https://github.com/ops-class/test161">GitHub page</a>.</p>
            </div>
            <div className="sect2">
              ...
              <div className="embed-responsive embed-responsive-16by9" style={{marginTop: 10, marginBottom: 10, border: '1px solid grey'}}>
                <div className="youtube-container" data-id="riGAGJx9tnw" />
              </div>
              <div className="paragraph">
                <p>Eventually <code>test161</code> will be distributed as part of the OS/161 toolchain,
                  allowing you to install it from the
                  <a href="https://launchpad.net/~geoffrey-challen/+archive/ubuntu/os161-toolchain/"><code>ops-class.org</code>
                    Launchpad PPA</a>. However, at the moment the installation is a bit more
                  complicated.</p>
              </div>
              <div className="sect3">
                <h4 id="_installing_go">1.1.1. Installing Go</h4>
                <div className="paragraph">
                  <p><code>test161</code> is written in <a href="https://golang.org/">Go</a> <sup className="footnote">[<a id="_footnoteref_1" className="footnote" href="#_footnote_1" title="View footnote.">1</a>]</sup>. So to install <code>test161</code> you must first
                    install Go.</p>
                </div>
                <div className="paragraph">
                  <p>Unfortunately, most Linux distributions package a fairly out-of-date version
                    ...
                    <a href="https://golang.org/dl/">most programming environments</a>. <strong>But keep in mind that
                    ...
                    <a href="https://launchpad.net/~ubuntu-lxc/+archive/ubuntu/lxd-stable">this PPA</a> that
                    maintains a more up-to-date version.</p>
                </div>
                <div className="paragraph">
                  <p>Probably the best alternative <a href="https://github.com/moovweb/gvm">GVM, the Go
              ...
              <div className="sect3">
                <h4 id="_setting_your_code_gopath_code">1.1.2. Setting your <code>GOPATH</code></h4>
                <div className="paragraph">
                  <p>Note that <code>gvm</code> will set your <code>GOPATH</code> and <code>PATH</code> variables properly to allow
                    ...
                    as described as <a href="https://golang.org/doc/code.html#GOPATH">described here.</a> If
            ...
            <div className="sect2">
              <h3 id="_installing_code_test161_code">1.2. Installing <code>test161</code></h3>
              <div className="paragraph">
            ...
            <div className="sect2">
              ...
              <div className="paragraph">
                <p><strong>Note that the <code>test161.conf</code> file is in <a href="http://yaml.org/">YAML</a> syntax and
        ...
        <div className="sect1">
          <h2 id="_running_code_test161_code_targets">2. Running <code>test161</code> Targets</h2>
          <div className="sectionbody">
            <div className="embed-responsive embed-responsive-16by9" style={{marginTop: 10, marginBottom: 10, border: '1px solid grey'}}>
              <div className="youtube-container" data-id="rPVtuUz1w5I" />
            </div>
            <div className="paragraph lead">
            ...
            <div className="paragraph">
              <p>For this example, we’ll assume that you want to run all tests for ASST1 and
                ...
                downloaded from the <a href="https://github.com/ops-class/os161"><code>ops-class.org</code> OS/161
            ...
            <div className="sect2">
              <h3 id="__code_sys161_code_output">2.1. <code>sys161</code> Output</h3>
              <div className="paragraph">
            ...
            <div className="sect2">
              <h3 id="_test_status">2.2. Test Status</h3>
              <div className="paragraph">
            ...
            <div className="sect2">
              <h3 id="_running_single_code_test161_code_tests">2.3. Running Single <code>test161</code> Tests</h3>
              <div className="paragraph">
            ...
            <div className="sect2">
              <h3 id="_running_groups_of_tests">2.4. Running Groups of Tests</h3>
              <div className="paragraph">
              ...
              <div className="listingblock">
                <div className="content">
                  <pre className="highlight"><code className="language-yaml" data-lang="yaml">---{"\n"}name: "Semaphore Test"{"\n"}tags:{"\n"}{"  "}- sync{"\n"}{"  "}- semaphore{"\n"}depends:{"\n"}{"  "}- boot{"\n"}---{"\n"}sem1</code></pre>
                </div>
              </div>
              <div className="paragraph">
        ...
        <div className="sect1">
          <h2 id="_submitting_using_code_test161_code">3. Submitting Using <code>test161</code></h2>
          <div className="sectionbody">
            <div className="paragraph lead">
              <p>Once you are happy with your score on each assignment <sup className="footnote">[<a id="_footnoteref_2" className="footnote" href="#_footnote_2" title="View footnote.">2</a>]</sup>, <code>test161</code> allows you to submit your assignments for
                automated grading.</p>
            </div>
            <div className="paragraph">
            ...
            <div className="sect2">
              <h3 id="_preparing_for_submission">3.1. Preparing for Submission</h3>
              <div className="embed-responsive embed-responsive-16by9" style={{marginTop: 10, marginBottom: 10, border: '1px solid grey'}}>
                <div className="youtube-container" data-id="wzS-moehW0I" />
              </div>
              <div className="paragraph">
                <p>To submit to <a href="https://test161.ops-class.org"><code>test161.ops-class.org</code></a>, you
              ...
              <div className="paragraph">
                <p>Log in to <a href="https://test161.ops-class.org"><code>test161.ops-class.org</code></a> and click on
              ...
              <div className="paragraph">
                <p>How to add this key differs depending on where you host your private OS/161
                  ...
                  <a href="https://developer.github.com/guides/managing-deploy-keys/">read-only deploy
                    keys</a>, as does <a href="http://doc.gitlab.com/ce/ssh/README.html">GitLab</a>. <strong>You should
            ...
            <div className="sect2">
              <h3 id="_configuration_for_submission">3.2. Configuration for Submission</h3>
              <div className="paragraph">
              ...
              <div className="paragraph">
                <p>The <code>token</code> value is the token that is shown on your
                  <a href="https://test161.ops-class.org"><code>test161.ops-class.org</code></a> profile page. If you
              ...
              <div className="paragraph">
                <p>At any point you can use the
                  <a href="https://test161.ops-class.org"><code>test161.ops-class.org</code></a> web interface to
        ...
        <div className="sect1">
          <h2 id="_writing_code_test161_code_tests">4. Writing <code>test161</code> Tests</h2>
          <div className="sectionbody">
            <div className="paragraph lead">
            ...
            <div className="sect2">
              <h3 id="_tests">4.1. Tests</h3>
              <div className="paragraph">
                <p>The main <code>test161</code> configuration object is a test, which are stored in files
                  with a <code>.t</code> extension <sup className="footnote">[<a id="_footnoteref_3" className="footnote" href="#_footnote_3" title="View footnote.">3</a>]</sup>. Here is an example
              ...
              <div className="sect3">
                <h4 id="_front_matter">4.1.1. Front matter</h4>
                <div className="paragraph">
                  <p>The test consist of two parts. The header in between the first and second
                    <code>---</code> is <a href="http://yaml.org">YAML</a> front matter that provides test metadata. Here
                ...
                <div className="paragraph">
                  <p>We will eventually provide more detail about test configuration options on
                    the <a href="https://github.com/ops-class/test161">GitHub page</a>, but for now you can
                    get a sense for the options by reading other test files and looking at the
                    <a href="https://github.com/ops-class/test161#default-settings"><code>test161</code> defaults</a>.
                    About the only commonly useful option not used by <code>sem1.t</code> is a <code>ram</code> option
                    for <code>sys161</code>.</p>
                </div>
              </div>
              <div className="sect3">
                <h4 id="_test_inputs">4.1.2. Test inputs</h4>
                <div className="paragraph">
                  <p>After the front matter comes the test itself. <code>test161</code> tests can be
                    ...
                    <a href="https://github.com/ops-class/test161#testfile-syntactic-sugar">syntactic
              ...
              <div className="sect3">
                <h4 id="_groups_of_tests">4.1.3. Groups of tests</h4>
                <div className="paragraph">
                ...
                <div className="listingblock">
                  <div className="content">
                    <pre className="highlight"><code className="language-bash" data-lang="bash">test161 run synch</code></pre>
                  </div>
                </div>
                <div className="paragraph">
            ...
            <div className="sect2">
              <h3 id="_identifying_single_tests">4.2. Identifying single tests</h3>
              <div className="paragraph">
            ...
            <div className="sect2">
              <h3 id="_commands">4.3. Commands</h3>
              <div className="paragraph">
              ...
              <div className="paragraph">
                <p><code>test161</code> reads this information from all files with <code>.tc</code> extensions in the
                  ...
                  <a href="http://yaml.org">YAML</a> syntax and can be processed in any order. Here is a
            ...
            <div className="sect2">
              ...
              <div className="paragraph">
                <p>Format is again, <a href="http://yaml.org">YAML</a>. This target tells <code>test161</code> to use
        ...
        <div id="footnotes">
          <hr />
          <div className="footnote" id="_footnote_1">
            <a href="#_footnoteref_1">1</a>. Which is awesome. <a href="https://tour.golang.org/">Learn it!</a>
          </div>
          <div className="footnote" id="_footnote_2">
            <a href="#_footnoteref_2">2</a>. Or with the deadline looming…​
          </div>
          <div className="footnote" id="_footnote_3">
            <a href="#_footnoteref_3">3</a>. In homage to the original <code>test161</code> tool that David wrote years ago that also used a <code>.t</code> extension.
          </div>
        </div>
      </div>
    );
